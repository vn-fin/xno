...
class OHLCVKafkaConsumer:
    ...
    def consume(self, callback: Callable) -> None:
        ...
        self._thread = threading.Thread(target=self._t_consume, name="KafkaOHLCVConsumer", daemon=True, args=(callback,))
        self._thread.start()
...
class OHLCVExternalService:
    def __init__(self, consumer_config: Dict[str, Any], db_name: str = "xno_data"):
        self._database_name = db_name
        self._consumer = OHLCVKafkaConsumer(**consumer_config)
    ...
    def start(self, on_consume_ohlcv: Callable, on_consume_order_book: Callable):
        ...
        self._consumer.consume(self._on_consume)
