...
# from xno.data2.fundamental.entity.vnstock.income_statement import IncomeStatement


# class IncomeStatementStore:
#     @classmethod
#     def singleton(cls):
...
#     def __init__(self):
#         self._store: dict[str, IncomeStatement] = dict()

#     def add(self, symbol: str, period: Period, value: IncomeStatement):
