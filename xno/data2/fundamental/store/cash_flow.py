...
# from xno.data2.fundamental.entity.vnstock.cash_flow import CashFlow
...
#     def __init__(self):
#         self._store: dict[str, CashFlow] = dict()

#     def add(self, symbol: str, period: Period, value: CashFlow):
